...
if __name__ == "__main__":
    ...
    parser.add_argument("--top_k", type=int, default=5, help="Top-K sampling for GPT (default: 5)")
    parser.add_argument("--top_p", type=float, default=1.0, help="Top-P (nucleus) sampling for GPT (default: 1.0)")
    parser.add_argument("--temperature", type=float, default=1.0, help="Temperature for GPT sampling (default: 1.0)")

...
function handleHandoff() {
  ...
  draft.sendToWorkspace(router)
}
</script>

<template>
  <div class="flex items-center justify-between bg-card rounded-card shadow-card py-3 px-5 border border-border dark:border-transparent">
